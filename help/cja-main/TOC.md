...
+ Grundlagen von Customer Journey Analytics {#cja-basics}
  ...
  + [Analytics in CJA: Neue Begriffe und ihre Zuordnung](cja-basics/new-terms-and-concepts-in-cja.md)
...
+ Customer Journey Analytics B2B Edition {#b2b}
  ...
  + [Integrieren von CJA mit Marketo für B2B-Erkenntnisse](b2b/integrate-cja-with-marketo-for-b2b-insights.md)
+ Remote-MCP-Server {#remote-mcp-server}
  + [Remote-MCP-Server für CJA - Übersicht](remote-mcp-server/remote-mcp-server-for-cja-overview.md)
  + [Remote-MCP-Server für CJA in Aktion](remote-mcp-server/remote-mcp-server-for-cja-in-action.md)
...
+ Verbindungen {#connections}
  ...
  + [Erste Schritte mit der Zielgruppenanalyse](connections/get-started-with-audience-analysis.md)
+ Besucheridentifizierung {#visitor-id}
  ...
  + [Überblick über die Zuordnung](visitor-id/overview-of-stitching.md)
  + [Validieren der Daten und Zusammenfügen der Qualität mithilfe der Vorschau](visitor-id/validate-identity-stitching-quality.md)
  + [Aktivierung und Validierung der Zuordnung](visitor-id/stitching-enablement-and-validation.md)
...
+ Datenansichten {#data-views}
  ...
  + Abgeleitete Felder{#derived-fields}
    ...
    + [Verwenden der Funktion „Mathematik“](data-views/derived-fields/use-the-math-function-in-derived-fields.md)
    ...
    + [Verwenden von Typecasting](data-views/derived-fields/use-typecasting-in-derived-fields.md)
    + [Verwenden von „Datumsberechnung“, um die Zeit zwischen Ereignissen zu ermitteln](data-views/derived-fields/use-date-math-to-calculate-time-between-events.md)
+ Data Insights Agent {#data-insights-agent}
  ...
  + [Verwenden von Data Insights Agent](data-insights-agent/use-the-data-insights-agent.md)
  + [Integration mit Microsoft 365 Copilot](data-insights-agent/data-insights-with-marketing-agent-365copilot.md)
+ Analysis Workspace {#analysis-workspace}
  + Workspace-Projekte {#workspace-projects}
    + [Analysis Workspace – Überblick](analysis-workspace/workspace-projects/analysis-workspace-overview.md)
    ...
    + [Arbeitsbereich-Kommentare](analysis-workspace/workspace-projects/workspace-commenting.md)
  ...
  + Panels {#panels}
    + [Hinzufügen von Komponenten zum Panel „Freiform“](analysis-workspace/panels/add-components-to-the-freeform-panel.md)
    + [Verwenden des Panels „Attribution“](analysis-workspace/panels/build-the-attribution-panel.md)
    + [Konfigurieren Sie das Panel für das nächste und vorherige Element](analysis-workspace/panels/configure-next-previous-item-panel.md)
    + [Verwenden des Experimentier-Bedienfelds](analysis-workspace/panels/use-the-experimentation-panel.md)
    + [Verwenden des Panels „Quick Insights“](analysis-workspace/panels/use-the-quick-insights-panel.md)
  + Vorlagen {#templates}
  ...
  + Visualisierungen {#visualizations}
    ...
    + [Live-Verknüpfung von Dimension-Diagrammen](analysis-workspace/visualizations/dimension-graph-live-linking.md)
    + [Erstellen intelligenter Beschriftungen](analysis-workspace/visualizations/intelligent-captions.md)
    + [Einstellungen für Tabellen und Visualisierungsdatenquellen](analysis-workspace/visualizations/cja-configure-table-and-visualization-data-source-settings.md)
    ...
    + [Hinzufügen von Trendlinien zu Linienvisualisierungen](analysis-workspace/visualizations/cja-add-trendlines-to-line-visualizations.md)
    + [Verwenden der Funktion „Kumulativer Durchschnitt“ für die Metrikausgleichung](analysis-workspace/visualizations/cja-use-the-cumulative-average-function-for-metric-smoothing.md)
  ...
  + Kalender und Datumsbereiche {#calendar-and-date-ranges}
    ...
    + [Verwenden von Datumsbereichen und -vergleichen](analysis-workspace/calendar-and-date-ranges/cja-use-date-ranges-and-comparisons.md)
  ...
  + Kuratieren und Freigeben {#curate-and-share}
    + [Daten-Storytelling: Generieren von Folienpräsentationen](analysis-workspace/curate-and-share/data-storytelling-generate-slides.md)
  ...
  + Tipps und Tricks {#tips-and-tricks}
    + [Erstellen von dynamischen Dropdown-Segmenten](analysis-workspace/tips-and-tricks/dynamic-drop-downs.md)
+ Adobe Product Analytics {#adobe-product-analytics}
  + [Adobe Product Analytics – Überblick](adobe-product-analytics/adobe-product-analytics-overview.md)
+ Geführte Analyse {#guided-analysis}
  + [Verwenden von geführten Analysen in Workspace](guided-analysis/guided-analysis-in-workspace.md)
...
+ Komponenten {#components}
  + Segmente {#filters}
    + [Segmente – Überblick](components/filters/introduction-to-filters-in-cja.md)
    + [Erstellen eines Schnellsegments](components/filters/create-a-quick-filter.md)
    + [Erstellen kanalübergreifender Segmente](components/filters/creating-cross-channel-filters-in-customer-journey-analytics.md)
...
+ Content Analytics {#content-analytics}
  ...
  + [Erstellen einer Konfiguration](content-analytics/create-configuration.md)
  + [Bearbeiten einer Konfiguration](content-analytics/edit-configuration.md)
...
+ Exportieren {#exporting}
  ...
  + [Verwalten und Verwalten vollständiger Tabellenexporte](exporting/manage-full-table-exports.md)
...
+ Reporting Activity Manager {#reporting-activity-manager}
  + [Verwenden des Reporting Activity Manager](reporting-activity-manager/use-the-reporting-activity-manager.md)
...
+ Anwendungsfälle {#use-cases}
  + Künstliche Intelligenz {#ai}
    + [Verfolgen und Analysieren von KI-Traffic](use-cases/ai/track-and-analyze-ai-traffic.md)
    + [Überprüfen der Datensatzqualität mit dem Data Engineering Agent](use-cases/ai/validate-dataset-quality-data-engineering-agent.md)
